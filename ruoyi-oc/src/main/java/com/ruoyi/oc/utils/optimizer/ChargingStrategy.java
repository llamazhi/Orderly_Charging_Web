package com.ruoyi.oc.utils.optimizer;
    ...
    public void evaluate(Solution solution) {
        ...
        for (double t = 0; t < 24; t += 0.25) {
            ...
            for (int i = 0; i < this.getNEVs(); i++) {
                ...
                double oldStartTime = ev.getChargingStartTime();
...
//                System.out.println("leavingTime: " + leavingTime);
//                System.out.println("newEndTime: " + newEndTime);
                ...
                // 检查充电时间约束条件
                if ((newStartTime > oldStartTime && newStartTime < 24) ||
                    (newStartTime < oldStartTime && newStartTime <= 3)) {
                    constraints[i] = 0.0;
                } else {
                    constraints[i] = newStartTime - oldStartTime;
                }

                if (newEndTime > 0 && newEndTime < leavingTime) {
                    constraints[i] = 0.0;
                } else {
